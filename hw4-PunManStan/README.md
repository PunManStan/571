# CS571-SU24 HW4: Badger Book (React!)
...
In `Classroom.jsx`, create a React state variable that will hold the array of student data. Then, fetch the student data from `https://cs571api.cs.wisc.edu/rest/su24/hw4/students` *on page load* and save it to this React state variable. Note three things...
