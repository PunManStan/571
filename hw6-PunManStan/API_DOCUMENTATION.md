# CS571 SU24 HW6 API Documentation

## At a Glance

All routes are relative to `https://cs571api.cs.wisc.edu/rest/su24/hw6/`
...
`GET` `https://cs571api.cs.wisc.edu/rest/su24/hw6/chatrooms`
...
`GET` `https://cs571api.cs.wisc.edu/rest/su24/hw6/messages?chatroom=CHATROOM_NAME&page=PAGE_NUM`
...
`POST` `https://cs571api.cs.wisc.edu/rest/su24/hw6/messages?chatroom=CHATROOM_NAME`
...
### Deleting a Message
`DELETE` `https://cs571api.cs.wisc.edu/rest/su24/hw6/messages?id=MESSAGE_ID`
...
### Logging out
`POST` `https://cs571api.cs.wisc.edu/rest/su24/hw6/logout`
...
### Who Am I?
`GET` `https://cs571api.cs.wisc.edu/rest/su24/hw6/whoami`
