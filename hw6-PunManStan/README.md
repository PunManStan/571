...
All data can be retrieved via API calls to `https://cs571api.cs.wisc.edu/rest/su24/hw6/`. A brief overview of the API is provided below. Please refer to `API_DOCUMENTATION.md` for details.
